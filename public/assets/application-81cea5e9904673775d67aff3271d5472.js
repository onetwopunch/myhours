...
(function() {
  $(function() {
    ...
    */
    ...
    var addErrorMessage, addErrorStyle, email, emailRegEx, email_tag, err_email, err_non_match, err_pass_len, err_user_exists, err_user_not_exists, f_email, hasErrorMessage, inputs, pass_tag, password, passwordRegEx, passwords, removeErrorMessage, removeErrorStyle, rep_pass, rep_pass_tag, user_is_new, validateEmail, validateForm, validateMatchingPasswords, validatePassword, validateUserExists;
    ...
    hasErrorMessage = function(element) {
      return $(element).html() && $(element).html().length() > 0;
    };
    ...
    */
    ...
    return validateUserExists = function(email, we_want_user_to_exist) {
      var user_exists;
      user_exists = false;
        ...
        complete: function(jqXHR, textStatus) {
          ...
          if (we_want_user_to_exist) {
            ...
            if (user_exists) {
              ...
              user_is_new = false;
              removeErrorStyle(email);
              return removeErrorMessage(email_tag);
            } else {
...
(function() {
  $(function() {
    var entry_listener, post_to_create, post_to_remove, post_to_show;
